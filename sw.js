...
const CACHE="osi-cache-v22s2";
const ASSETS=[
  "./","./index.html?v=22s2","./app.js?v=22s2","./auth.js?v=22s2","./manifest.webmanifest",
...
self.addEventListener("fetch",e=>{
  ...
  if(url.origin===self.location.origin&&(url.pathname.endsWith(".html")||url.pathname.endsWith(".js"))) url.searchParams.set("v","22s2");
