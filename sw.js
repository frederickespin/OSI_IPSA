...
const CACHE="osi-cache-v22s3";
const ASSETS=[
  "./","./index.html?v=22s3","./app.js?v=22s3","./auth.js?v=22s3","./settings.html?v=22s3","./settings.js?v=22s3","./manifest.webmanifest",
...
self.addEventListener("fetch",e=>{
  ...
  if(url.origin===self.location.origin&&(url.pathname.endsWith(".html")||url.pathname.endsWith(".js"))) url.searchParams.set("v","22s3");
