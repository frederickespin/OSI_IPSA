...
const CACHE="osi-cache-v22s6";
const ASSETS=[
  "./","./index.html?v=22s6","./app.js?v=22s6","./auth.js?v=22s6","./settings.html?v=22s6","./settings.js?v=22s6","./manifest.webmanifest",
...
self.addEventListener("fetch",e=>{
  ...
  if(url.origin===self.location.origin&&(url.pathname.endsWith(".html")||url.pathname.endsWith(".js"))) url.searchParams.set("v","22s6");
