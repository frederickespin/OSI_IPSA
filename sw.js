...
const CACHE="osi-cache-v22s5";
const ASSETS=[
  "./","./index.html?v=22s5","./app.js?v=22s5","./auth.js?v=22s5","./settings.html?v=22s5","./settings.js?v=22s5","./manifest.webmanifest",
...
self.addEventListener("fetch",e=>{
  ...
  if(url.origin===self.location.origin&&(url.pathname.endsWith(".html")||url.pathname.endsWith(".js"))) url.searchParams.set("v","22s5");
